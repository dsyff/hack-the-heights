...
public class EmailActivity extends AppCompatActivity{
    ...
    return "Dear Professor"+" "+professor+","+ "\n" +"\n"+
            "   I am afraid that I might not be able to attend to your "+course+ " class today due to fact that I got a severe stomache last night. If possible, please give me the details of the assignment and homework to be assigned this week, so I can finish my homework on time.\n" +
